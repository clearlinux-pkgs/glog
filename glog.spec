...
Version  : 0.5.0
Release  : 14
URL      : https://github.com/google/glog/archive/v0.5.0/glog-0.5.0.tar.gz
Source0  : https://github.com/google/glog/archive/v0.5.0/glog-0.5.0.tar.gz
...
%prep
%setup -q -n glog-0.5.0
cd %{_builddir}/glog-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644263871
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/glog-0.5.0/COPYING %{buildroot}/usr/share/package-licenses/glog/43c9d4e201bf773d965455b593cd8a244d98564b
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build
...
%files
%defattr(-,root,root,-)
/usr/usr/lib64/cmake/glog/glog-modules.cmake
