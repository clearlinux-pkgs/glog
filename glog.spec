...
Version  : 0.7.0
Release  : 28
URL      : https://github.com/google/glog/archive/v0.7.0/glog-0.7.0.tar.gz
Source0  : https://github.com/google/glog/archive/v0.7.0/glog-0.7.0.tar.gz
...
%prep
%setup -q -n glog-0.7.0
cd %{_builddir}/glog-0.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708361717
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libglog.so.0.7.0
/usr/lib64/libglog.so.0.7.0
